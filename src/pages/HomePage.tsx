...
const HomePage: React.FC = () => {
  return (
    <div className="container mx-auto px-6 py-12 md:py-20 text-center">
      <div className="inline-flex items-center bg-white/5 text-blue-300 text-sm font-semibold px-4 py-1.5 rounded-full mb-4">
      ...
      <p className="text-xl md:text-2xl font-semibold text-white max-w-2xl mx-auto mb-6">
        Your JLHS Learning Assistant
      </p>
       <p className="text-md text-slate-400 max-w-3xl mx-auto mb-12">
